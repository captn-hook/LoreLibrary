...
# Define variables
url="https://86vprgw5q5.execute-api.us-west-2.amazonaws.com/prod"
token=""
username=""
...
world_content=$(jq -n --arg text "Grub World" --arg image_url "https://upload.wikimedia.org/wikipedia/commons/thumb/2/2d/Hercules_beetle_%28larva%29.jpg/330px-Hercules_beetle_%28larva%29.jpg" --arg name "Grub World" \
    '[{"text": $text}, {"image_url": $image_url}, {"name": $name}, {"bulletList": [{text: "its a bugly planet", subItems: [{text: "it has bugs", subItems: []}]}]}]')
